...
public class CodeGenerator {
    ...
    private static String author ="怪盗一只羊";//作者名称
    private static String outputDir ="E:\\";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/db_furnituremall?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
